          ...
          {isAdmin && (
            <li className="flex lg:hidden">
              <Link
                ...
                className="flex items-center w-full h-full px-4 py-2 text-blue-400 hover:text-blue-300"
              >
                <svg
                  width="16"
                  height="16"
  ...
  return (
    <header className="pointer-events-auto w-full px-3.5 gap-4 xs:px-6 sm:px-12 py-6 flex items-center justify-between bg-background-secondary border-b border-solid border-border-primary">
      ...
      <div className="flex-1 flex justify-center lg:flex-none lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2">
        <Link 
          href={isAdmin ? "/admin" : "/"} 
          className="text-2xl font-bold text-[#EDEDED] hover:text-[#A1A1A1] transition-colors"
        >
          VACHETTA
        </Link>
      </div>
