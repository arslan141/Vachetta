  ...
  const handleSubmit = useCallback(
    async (event: FormEvent<HTMLFormElement>) => {
      ...
      try {
        ...
        // Use relative URL for signup
        const signupResponse = await axios.post("/api/auth/signup", requestData);
  ...
  return (
    <section className="flex items-center justify-center w-full pt-12 xs:h-80vh">
      ...
      >
        ...
        <button
          className="w-full bg-black border border-solid border-[#2E2E2E] py-1.5 mt-2.5 rounded transition-all hover:bg-[#1F1F1F] hover:border-[#454545] text-13 disabled:opacity-50 disabled:cursor-not-allowed"
          type="submit"
          disabled={isLoading}
        >
        ...
        <button
          className="flex text-[#A1A1A1] items-center gap-3 px-4 py-2 text-sm align-middle transition-all bg-black border border-solid rounded border-border-primary ease hover:bg-[#1F1F1F] hover:border-[#454545] disabled:opacity-50 disabled:cursor-not-allowed"
